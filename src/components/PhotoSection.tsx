...
export const PhotoSection = () => {
  return <section className="py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-12">
          <h2 className="font-dancing text-4xl md:text-6xl text-foreground mb-4 glow-animation">❤️ Special Photos, Special Memoria's</h2>
        ...
        <div className="relative">
          <div className="grid grid-cols-2 gap-8 md:gap-12 max-w-4xl mx-auto">
            ...
            <div className="relative group">
              <div className="w-60 h-60 md:w-72 md:h-72 mx-auto relative transform rotate-2 hover:rotate-0 transition-magic hover:scale-105 magic-shadow" style={{
            ...
            {/* Frame 2 */}
            <div className="relative group">
              <div className="w-60 h-60 md:w-72 md:h-72 mx-auto relative transform -rotate-1 hover:rotate-0 transition-magic hover:scale-105 magic-shadow" style={{
              backgroundImage: `url(${polaroidFrame})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            }}>
          ...
          {[...Array(12)].map((_, i) => <Sparkles key={i} className={`absolute text-magic-pink sparkle-animation pointer-events-none`} style={{
